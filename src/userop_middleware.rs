...
impl<M: Middleware + 'static + fmt::Debug + Clone> UserOpMiddleware<M> {
    ...
    //         .set_uo_nonce(nonce)
    //         .set_uo_factory(Address::zero())
    //         .set_uo_factory_data(Bytes::default())
    //         .set_uo_call_data(execution_calldata.into())
    //         .set_uo_call_gas_limit(U256::zero())
    //         .set_uo_verification_gas_limit(U256::zero())
    //         .set_uo_pre_verification_gas(1u64.into())
    //         .set_uo_max_fee_per_gas(U256::zero())
    //         .set_uo_max_priority_fee_per_gas(U256::zero())
    //         .set_uo_paymaster("0x".to_string())
    //         .set_uo_paymaster_verification_gas_limit(U256::zero())
    //         .set_uo_paymaster_post_op_gas_limit(U256::zero())
    //         .set_uo_paymaster_data(Bytes::default())
    ...
    //                             call_gas_limit = U256::from(*estimation);
    ...
    //                             calculated,
    //                         ) => {
    //                             pre_verification_gas = U256::from(*calculated);
    //                             log::warn!("Pre-verification gas i not enough. Retry with pre_verification_gas increased to {}", &calculated);
    //                         }
    //                         UserOpMiddlewareError::VerificationGasLimitError => {
    //                             verification_gas_limit += U256::from(10000);
